...
// void FrameBufferOperation::SetFrameBuffer(std::shared_ptr<Buffer::FrameBuffer> buffer)
// {
//     this->frame_buffer_ptr = buffer;
// }

// void FrameBufferOperation::SetDepthBuffer(std::shared_ptr<Buffer::DepthBuffer> buffer)
// {
//     this->depth_buffer_ptr = buffer;
// }

// void FrameBufferOperation::WriteFragment2Buffer(const std::vector<Primitives::Fragment>& fragments)
// {
